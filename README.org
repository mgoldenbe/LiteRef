...
* 3 Features @@html:<a name="features">@@
:PROPERTIES:
:CUSTOM_ID: features
:END:
...
*** 3.1.1 By putting a /.bib/ file into the =drop/= folder. @@html:<a name="import-bib-drop">@@
:PROPERTIES:
...
#+END_HTML
*** 3.1.2 By copying a BibTeX entry into the clipboard @@html:<a name="import-bib-clipboard">@@
:PROPERTIES:
...
#+END_HTML
*** 3.1.3 By searching in on-line sources @@html:<a name="import-search-online">@@
:PROPERTIES:
...
*** 3.1.4 By downloading an HTML containing a number of papers @@html:<a name="import-html">@@
:PROPERTIES:
