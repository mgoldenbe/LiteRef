...
* 1 Introduction @@html:<a name="intro">@@
:PROPERTIES:
:CUSTOM_ID: intro
:END:
...
* 2 The overall design @@html:<a name="design">@@
:PROPERTIES:
:CUSTOM_ID: design
:END:
...
** 2.1 Physical structure @@html:<a name="phys">@@
:PROPERTIES:
:CUSTOM_ID: phys
:END:
...
** 2.2 The user interface @@html:<a name="ui">@@
:PROPERTIES:
:CUSTOM_ID: ui
:END:
...
** 2.3 Import of entries @@html:<a name="import">@@
:PROPERTIES:
:CUSTOM_ID: import
:END:
...
** 2.4 Paper citations @@html:<a name="cite">@@
:PROPERTIES:
:CUSTOM_ID: cite
:END:
...
* Features @@html:<a name="features">@@
:PROPERTIES:
:CUSTOM_ID: features
:END:
This section describes the features of =LiteRef= in detail.
** 3.1 Importing BibTeX entries @@html:<a name="import-bib">@@
:PROPERTIES:
...
*** 3.1.1 By putting a /.bib/ file into the =drop/= folder. @@html:<a 3.1.2 name="import-bib-drop">@@
:PROPERTIES:
...
#+END_HTML
*** 3.1.3 By copying a BibTeX entry into the clipboard @@html:<a name="import-bib-clipboard">@@
:PROPERTIES:
...
#+END_HTML
*** 3.1.4 By searching in on-line sources @@html:<a name="import-search-online">@@
:PROPERTIES:
...
*** 3.1.5 By downloading an HTML containing a number of papers @@html:<a name="import-html">@@
:PROPERTIES:
...
** 3.2 Working with citations @@html:<a name="working-cite">@@
:PROPERTIES:
...
*** 3.2.1 Searching the papers database @@html:<a name="search">@@
:PROPERTIES:
:CUSTOM_ID: search
:END:
...
#+END_HTML
*** 3.2.2 Intelligent handling of copying and pasting citations @@html:<a name="copy-paste">@@
:PROPERTIES:
...
*** 3.2.3 Splitting a multi-paper citation @@html:<a name="split">@@
:PROPERTIES:
:CUSTOM_ID: split
:END:
...
*** 3.2.4 Actions on a paper @@html:<a name="actions">@@
:PROPERTIES:
:CUSTOM_ID: actions
:END:
...
** 3.3 Importing PDF of a paper @@html:<a name="import-pdf">@@
:PROPERTIES:
...
** 3.4 Working with PDF @@html:<a name="working-pdf">@@
:PROPERTIES:
...
** 3.5 Basic export of notes @@html:<a name="basic-export">@@
:PROPERTIES:
:CUSTOM_ID: intro
:END:
...
#+END_HTML
** 3.6 Defining and using citation functions @@html:<a name="cf">@@
:PROPERTIES:
:CUSTOM_ID: cf
:END:
...
#+END_HTML
** 3.7 The citation (sub-)graph @@html:<a name="subgraph">@@
:PROPERTIES:
:CUSTOM_ID: subgraph
:END:
*** 3.7.1 The notion of the citation graph @@html:<a name="graph-notion">@@
:PROPERTIES:
...
*** 3.7.2 The notion of the citation sub-graph @@html:<a name="subgraph-notion">@@
:PROPERTIES:
...
*** 3.7.3 Building a citation sub-graph @@html:<a name="subgraph-build">@@
:PROPERTIES:
...
** 3.8 Operations on the citation sub-graph @@html:<a name="subgraph-operations">@@
:PROPERTIES:
...
*** 3.8.1 Visualization @@html:<a name="subgraph-vis">@@
:PROPERTIES:
...
*** 3.8.2 Search @@html:<a name="subgraph-search">@@
:PROPERTIES:
...
#+END_HTML   
*** 3.8.3 Export @@html:<a name="subgraph-export">@@
:PROPERTIES:
...
#+END_HTML 
*** 3.8.4 Visualization in export @@html:<a name="subgraph-vis-export">@@
:PROPERTIES:
...
#+END_HTML
* 4 Installation and configuration @@html:<a name="install">@@
:PROPERTIES:
:CUSTOM_ID: install
:END:
* 5 Version and license information @@html:<a name="license">@@
:PROPERTIES:
:CUSTOM_ID: license
:END:
