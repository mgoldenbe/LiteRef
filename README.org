...
- [[#the-overall-design][The overall design]]
  ...
  - [[#import-of-entries][Import of entries]]
  - [[#working-with-the-papers][Working with the papers]]
- [[#features][Features]]
  - [[#importing-bibtex-entries][Importing BibTeX entries]]
  - [[#working-with-citations][Working with citations]]
  - [[#importing-pdf-of-a-paper][Importing PDF of a paper]]
  - [[#working-with-pdf][Working with PDF]]
  - [[#basic-export-of-notes][Basic export of notes]]
  - [[#defining-and-using-citation-functions][Defining and using citation functions]]
  - [[#the-citation-sub-graph][The citation (sub-)graph]]
  - [[#operations-on-the-citation-sub-graph][Operations on the citation sub-graph]]
- [[#installation-and-configuration][Installation and configuration]]
- [[#version-and-license-information][Version and license information]]
- [[#bug-reports-and-future-work][Bug reports and future work]]
...
Since a [[#Visualization][later section]] introduces the visualization of the selected sub-graph, we delay the demonstration of selecting the sub-graph till that section. 
