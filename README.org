...
The configuration variables of the server and of the command layer are defined and documented in [[https://github.com/mgoldenbe/LiteRef/blob/master/el/py/config.py][config.py]] and [[https://github.com/mgoldenbe/LiteRef/blob/master/el/literef-config.el][config.el]], respectively.
