...
(setq latex-full-map
	...
	("{\\ss}" ?ß)
	("{\\th}" ?þ)
	;; ("'" ?′) ; these were transferred to the end to not interfere.
...
;; (defun fun-with-message(orig-fun &rest args)
;;   (message "Entered")
;;   (apply orig-fun args))
;; (advice-add 'bibtex-completion-apa-get-value :around
;; 	    #'fun-with-message)
;; (advice-add 'bibtex-completion-get-entry1 :around
;; 	    #'fun-with-message)
;; (advice-remove 'bibtex-completion-apa-get-value
;; 	    #'fun-with-message)
;; (message "------------START-----------")

(advice-add 'bibtex-completion-get-value :around
